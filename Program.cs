...
class Program
{
    ...
    {
        string src1 = @"C:\Users\Alena\Desktop\Введение.docx";
        string src2 = @"C:\Users\Alena\Desktop\test5laba.docx";

        string dest1 = @"C:\Users\Alena\Desktop\Doc1.docx";
        string dest2 = @"C:\Users\Alena\Desktop\Doc2.docx";
        try
        {
            if (File.Exists(src1))
            {
